...
public class Funcionario implements Serializable {
	...
	public Date getDataAtualizaçao() {
		return dataAtualizaçao;
	}

	public void setDataAtualizaçao(Date dataAtualizaçao) {
	...
	public void prePersist() {
		...
		dataCriacao = atual;
		dataAtualizaçao = atual;
	}

	@Override
	public String toString() {
		return "Funcionario [id=" + id + ", nome=" + nome + ", email=" + email + ", senha=" + senha + ", cpf=" + cpf
				+ ", valorHora=" + valorHora + ", qtdHorasTrabalhoDia=" + qtdHorasTrabalhoDia + ", qtdHorasAlmoço="
				+ qtdHorasAlmoço + ", perfil=" + perfil + ", dataCriacao=" + dataCriacao + ", dataAtualizaçao="
				+ dataAtualizaçao + ", empresa=" + empresa + ", lancamento=" + lancamento + "]";
	}
